...
def process_captcha_input(message):
    ...
    try:      
        ...
        process_btn_xpaths = [
            ...
            "//button[contains(normalize-space(.),'Process') or contains(normalize-space(.),'प्रक्रिया') or contains(normalize-space(.),'Proceed') or contains(normalize-space(.),'आगे बढ़ें')]",
