...
def process_service_type(message):
    ...
    bot.send_message(message.chat.id, f"सर्विस '{service}' चुनी गई।\n\n📄 अब अपना आधिकारिक डॉक्यूमेंट (आधार/अन्य पहचान पत्र PDF या Photo) भेजें:")      
...
def process_document_upload(message):
    ...
    if gemini_client:
        ...
        try:
            ...
            # Redact Aadhaar digits safely in internal memory/draft representation
            if extracted.get("aadhaar_number"):
                extracted["aadhaar_number"] = "[Aadhaar Redacted]"
            ...
            preview_text += "📞 कृपया अपना **Mobile Number** और **Email ID** इस फ़ॉर्मेट में भेजें:\n`9876543210, your_email@gmail.com`"

            bot.send_message(chat_id, preview_text, parse_mode="Markdown")
