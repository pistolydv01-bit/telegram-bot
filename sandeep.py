...
def fill_initial_rtps_form(driver, user_data, service_type, photo_path, chat_id=None, user_id=None):
    ...
    # ============================================================
    # MOBILE NUMBER - ABSOLUTELY LAST FIELD & ENTER TRIGGER
    # ============================================================
    try:
        mobile_xpaths = [
        ...
        # ========================================================
        # MOBILE VERIFICATION CONSENT POPUP - AGREE
        # ========================================================
        ...
        try:
            ...
            logging.info(
                f"ℹ️ Agree popup not found or already handled: {e}"
            )
        ...
        if detect_mobile_otp_popup(driver, timeout=10):
            ...
            logging.warning(
                "⚠️ Mobile OTP popup detected नहीं हुआ"
            )

    except Exception as e:
        logging.warning(
            f"⚠️ Final Mobile number / OTP trigger warning: {e}"
        )
