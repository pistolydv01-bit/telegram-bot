...
from selenium.common.exceptions import NoSuchElementException, TimeoutException, StaleElementReferenceException, AlertNotPresentException
...
def process_mobile_otp_input(message):
    ...
    try:      
        ...
        try:
            ...
            # Check if "Verified" exists in alert text (case-insensitive)
