...
# -------------------------------------------------------------------    
# Driver Setup (Render Cloud Friendly Chromium Options)    
# -------------------------------------------------------------------    
...
# -------------------------------------------------------------------    
# Dummy Health Check Server (Render Port Binding Fix)
# -------------------------------------------------------------------    
class HealthCheckHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        # Console me फालतू HTTP logs न आएँ
        return

def run_dummy_server():
    port = int(os.environ.get("PORT", 10000))
    server = HTTPServer(("0.0.0.0", port), HealthCheckHandler)
    logging.info(f"🌐 Fake Health Check Server Running on Port {port}")
    server.serve_forever()

if __name__ == "__main__":    
    # HTTP Web Server को Background Thread में start करें
