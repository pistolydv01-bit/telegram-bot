...
def process_captcha_input(message):
    ...
    try:
        ...
        # Some RTPS screens show an I Agree/Agreement control immediately
        # after Proceed. If present, click it; otherwise continue normally.
        click_agreement_if_present(driver, chat_id=chat_id, timeout=8)
        time.sleep(0.5)
