# ===================================================================
# Python Telegram Bot Source Code (Updated)
# ===================================================================
...
# ===================================================================
# UPDATED: process_mobile_otp_input Function
# ===================================================================
...
def process_mobile_otp_input(message):
    ...
    try:      
        ...
        # Input box me OTP dalne ke baad thoda pause ताकि पेज स्टेबल रहे
        time.sleep(1.5)      
        ...
        # Screenshot for debugging after entering OTP
        ...
        time.sleep(1) # वैलिडेट क्लिक करने से पहले हल्का पॉज
        ...
        # पोर्टल का रिस्पांस आने का हल्का इंतज़ार (4 सेकंड)
        time.sleep(4)      
        
        # क्लिक होने के तुरंत बाद का स्क्रीनशॉट
        ...
        # OTP वाला पेज खत्म होने के बाद नए पेज का स्क्रीनशॉट
