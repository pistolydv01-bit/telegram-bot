...
"//div[contains(@class,'modal') and contains(normalize-space(.),'Validate OTP')]//input[not(@type='hidden')]",
"//[@role='dialog' and contains(normalize-space(.),'Validate OTP')]//input[not(@type='hidden')]",
"//[contains(normalize-space(.),'Validate OTP')]/following::input[not(@type='hidden')][1]",
...
"""
OTP submit के बाद केवल स्पष्ट portal response को success मानता है।
UNKNOWN होने पर success assume नहीं करता।
"""
start = time.time()
success_xpaths = [
...
# 2. Click Email field / trigger RTPS Validate OTP popup  
if user_data.get("email"):      
    try:      
        ...
        # Check if Mobile OTP Popup appeared  
...
try:      
    ...
    validate_btn_xpaths = [      
        "//div[contains(@class,'modal') and contains(normalize-space(.),'Validate OTP')]//button[contains(normalize-space(.),'Validate')]",      
        "//div[contains(@class,'modal') and contains(normalize-space(.),'Validate OTP')]//input[contains(@value,'Validate')]",      
        "//*[@role='dialog' and contains(normalize-space(.),'Validate OTP')]//button[contains(normalize-space(.),'Validate')]",      
        "//*[@role='dialog' and contains(normalize-space(.),'Validate OTP')]//input[contains(@value,'Validate')]",      
    ...
    # केवल explicit SUCCESS मिलने पर आगे बढ़ें  
    session["is_processing"] = False  
    session["last_activity"] = time.time()  
    bot.send_message(  
