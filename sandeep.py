...
def process_captcha_input(message):
    ...
    try:
        ...
        if step == "UNKNOWN":
            ...
            bot.send_message(
                chat_id,
                "⚠️ Proceed पर click हो चुका है, लेकिन RTPS ने अभी अगला step नहीं दिखाया।\n"
                "❗ इसे CAPTCHA गलत नहीं माना गया है।\n"
                "⏳ पहले देखें कि कोई RTPS validation alert तो नहीं आया। जरूरत हो तो कुछ सेकंड बाद फिर check करें।"
            )
            bot.set_state(user_id, RTPSState.captcha_input, chat_id)
            return
