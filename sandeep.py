...
def get_chrome_driver(chat_id):    
    ...
    # Hindi Language Fix for Linux/Render Environments
...
# -------------------------------------------------------------------    
# RTPS Form Filling Logic (Robust Navigation with Menu Fallback)
# -------------------------------------------------------------------    
def fill_initial_rtps_form(driver, user_data, service_type, photo_path, chat_id=None):    
    ...
    try:
        ...
        find_and_interact(driver, [
            ...
            "//a[contains(@href, 'GAD') or contains(@onclick, 'GAD')]"
        ])
        time.sleep(2)
        
        service_links = {
            "RESIDENCE": [
                "//a[contains(text(), 'आवासीय प्रमाण-पत्र का निर्गमन') or contains(text(), 'आवासीय प्रमाण पत्र')]",
                "//a[contains(@href, 'residence') or contains(@onclick, 'residence')]"
            ],
            "CASTE": [
                "//a[contains(text(), 'जाति प्रमाण-पत्र का निर्गमन') or contains(text(), 'जाति प्रमाण पत्र')]",
                "//a[contains(@href, 'caste') or contains(@onclick, 'caste')]"
            ],
            "INCOME": [
                "//a[contains(text(), 'आय प्रमाण-पत्र का निर्गमन') or contains(text(), 'आय प्रमाण पत्र')]",
