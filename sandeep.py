...
def fill_final_email_mobile_and_wait_for_otp(driver, user_data, chat_id=None, user_id=None):
    ...
    # Mobile number के बाद RTPS का Validate button आता है.
    # Validate click के बाद Consent/Agree popup को handle करें.
    click_mobile_validate_then_agree(driver, chat_id=chat_id, timeout=15)
