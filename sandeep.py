...
def continue_rtps_form_after_mobile_otp(driver, user_data, service_type, photo_path, chat_id=None, user_id=None):
    try:
        # समाधान 1 के अनुसार यहाँ Explicit Wait जोड़ा गया है ताकि DOM लोड होने का इंतज़ार हो सके
        wait = WebDriverWait(driver, 20)
        wait.until(EC.presence_of_element_located((By.XPATH, "//select[@id='state' or contains(@name, 'state')]")))
        time.sleep(2)  # अतिरिक्त स्थिरता के लिए
...
# ===================================================================
# UPDATED: process_mobile_otp_input Function with "Verified" Alert Check Logic & Stability Pause
# ===================================================================
...
def process_mobile_otp_input(message):
    ...
    try:      
        ...
        # "Please wait..." स्क्रीन आने पर तुरंत Telegram पर Screenshot भेजने के लिए
        send_step_screenshot = lambda d, cid, cap: debug_screenshot(d, cid, cap) # fallback/alias helper
        try:
        ...
        # समाधान 2 के अनुसार यहाँ स्टेबिलिटी पॉज (Stability Pause) जोड़ा गया है
        time.sleep(3) 
        try: 
            debug_screenshot(driver, chat_id, "READY_FOR_NEXT_FIELDS") 
        except Exception: 
            pass
        ...
        # Evaluate final OTP result based on alert check + DOM state
