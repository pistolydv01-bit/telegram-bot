    ...
    try:
        ...
        if panchayat:
                ...
                try:
                    ...
                    for option in options:
                        ...
                        if text_norm == target or target in text_norm or text_norm in target:
                            ...
                            selected_text = " ".join((selected.text or "").split()).strip()
                            selected_value = (selected.get_attribute("value") or "").strip()
            ...
            if not selected_ok:
                try:
                    gp = driver.find_element(By.ID, "56895")
                    available = [" ".join((o.text or "").split()).strip() for o in Select(gp).options]
                except Exception:
                    available = []
        ...
        # 10. POLICE STATION (ID = 65010) - THIS IS SELECT, NOT INPUT
