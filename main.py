...
# ==========================================
ADMIN_ID = 123456789          # Aapki Telegram User ID
ADMIN_USERNAME = "your_username"  # Aapka Telegram Username (bina @ ke)
# ==========================================
...
def generate_report(query, query_id):
    ...
    if "List" in response:
        for database_name in response["List"].keys():
            ...
            # Information Output ke niche Developer aur Owner Credit
