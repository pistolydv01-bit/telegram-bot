...
def get_main_user_keyboard():
    ...
    btn11 = KeyboardButton("💳 Buy Subscription")
...
# --- Helper for Under Maintenance Message ---
def send_maintenance_message(chat_id, tool_name):
    markup = InlineKeyboardMarkup()
    markup.add(InlineKeyboardButton(text="📢 Join Group for Updates", url=OFFICIAL_GROUP_LINK))

    msg = (
        f"🛠 <b>Tool Under Maintenance!</b>\n\n"
        f"⚠️ <b>{tool_name}</b> फ़ीचर अभी अपडेट में है और इसके API पर काम चल रहा है।\n\n"
        f"📢 <i>जैसे ही यह टूल पूरी तरह चालू होगा, इसकी जानकारी सबसे पहले हमारे ऑफिशियल ग्रुप में दी जाएगी। कृपया अपडेट्स के लिए ग्रुप जॉइन कर लें।</i>"
    )
...
def handle_message(message):
    ...
    if text == "🔎 Advance Info":
        ...
        send_maintenance_message(chat_id, text)
        return
